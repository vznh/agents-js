...
- feat(inworld): add STT plugin with voice profiling support - [#1516](https://github.com/livekit/agents-js/pull/1516) ([@karan-dhir](https://github.com/karan-dhir))
...
- Harden the Inworld TTS connection layer (retryable framework errors, a handshake timeout and a bounded in-turn wait, and no in-plugin backoff so retries are delegated to the framework) and change the defaults to the `inworld-tts-2` model and `Jason` voice. - [#1675](https://github.com/livekit/agents-js/pull/1675) ([@cshape](https://github.com/cshape))
...
- Add support for Inworld TTS delivery mode. - [#1577](https://github.com/livekit/agents-js/pull/1577) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Add language option support to Inworld TTS requests. - [#1488](https://github.com/livekit/agents-js/pull/1488) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
