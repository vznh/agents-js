...
- fix(sarvam): thread language_probability into STT confidence - [#1591](https://github.com/livekit/agents-js/pull/1591) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
