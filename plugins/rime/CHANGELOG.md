...
- feat(rime): add WebSocket streaming TTS support - [#1497](https://github.com/livekit/agents-js/pull/1497) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Stream Rime TTS response chunks as they arrive instead of waiting for the full response body. - [#1405](https://github.com/livekit/agents-js/pull/1405) ([@chasef07](https://github.com/chasef07))
...
- Add Rime TTS plugin for LiveKit agents - [#734](https://github.com/livekit/agents-js/pull/734) ([@toubatbrian](https://github.com/toubatbrian))
