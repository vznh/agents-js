...
- fix(cartesia): surface TTS websocket server errors - [#1534](https://github.com/livekit/agents-js/pull/1534) ([@bowdens](https://github.com/bowdens))
...
- Support cartesia TTS volume options - [#1101](https://github.com/livekit/agents-js/pull/1101) ([@toubatbrian](https://github.com/toubatbrian))

- Add max_buffer_delay_ms to cartesia TTS plugin - [#1107](https://github.com/livekit/agents-js/pull/1107) ([@tycartesia](https://github.com/tycartesia))
