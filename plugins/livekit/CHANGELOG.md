...
- fix(livekit): skip system and developer messages when building EOU input; the previous `in` check never matched and let those messages reach the end-of-utterance model as user turns - [#1469](https://github.com/livekit/agents-js/pull/1469) ([@u9g](https://github.com/u9g))
