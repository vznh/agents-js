...
- Batch streamed text into sentences before sending it to the Neuphonic websocket (matching the Python plugin), with a configurable `tokenizer` option. This also anchors TTS TTFB on the first sentence sent to the provider instead of the first LLM token. - [#1955](https://github.com/livekit/agents-js/pull/1955) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Send Neuphonic WebSocket TTS API keys via header authentication instead of query parameters. - [#1452](https://github.com/livekit/agents-js/pull/1452) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
