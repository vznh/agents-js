...
- Add `zh-HK` to the supported Deepgram STT languages. - [#2086](https://github.com/livekit/agents-js/pull/2086) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Avoid serializing an unset Deepgram STT redact query parameter. - [#1893](https://github.com/livekit/agents-js/pull/1893) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- fix(deepgram): add per-message receive timeout to TTS WebSocket. - [#1528](https://github.com/livekit/agents-js/pull/1528) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Add `speed` option to Deepgram TTS (0.7–1.5). - [#1356](https://github.com/livekit/agents-js/pull/1356) ([@adrivelasco](https://github.com/adrivelasco))
...
- add baseUrl to deepgram STT - [#1106](https://github.com/livekit/agents-js/pull/1106) ([@nataly87s](https://github.com/nataly87s))

- fix(deepgram): prevent TypeError in STTv2 #sendTask on stream teardown - [#1111](https://github.com/livekit/agents-js/pull/1111) ([@mykmelez](https://github.com/mykmelez))
...
- Added support for mip_opt_out option - [#886](https://github.com/livekit/agents-js/pull/886) ([@alexshye](https://github.com/alexshye))
...
- catch closed WebSocket connection - [#288](https://github.com/livekit/agents-js/pull/288) ([@viplifes](https://github.com/viplifes))

- add deepgram nova 3 to model options - [#303](https://github.com/livekit/agents-js/pull/303) ([@mph6083](https://github.com/mph6083))

- add missing STT options - [#295](https://github.com/livekit/agents-js/pull/295) ([@sachin4840](https://github.com/sachin4840))
