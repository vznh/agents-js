...
- Add the ability for users to provide a local image to the LemonSlice transport to be used as the avatar image. - [#1986](https://github.com/livekit/agents-js/pull/1986) ([@jp-lemon](https://github.com/jp-lemon))

- Convert extrapayload to snake_case - [#2034](https://github.com/livekit/agents-js/pull/2034) ([@aweitz](https://github.com/aweitz))

- Add external meeting support to the LemonSlice avatar plugin: `joinMeeting()` and `leaveMeeting()` send the avatar into Zoom, Google Meet, Microsoft Teams, or Webex meetings, stream mixed meeting audio into the agent session's STT, and optionally relay meeting chat messages as user input. - [#2036](https://github.com/livekit/agents-js/pull/2036) ([@aweitz](https://github.com/aweitz))
