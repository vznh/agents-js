...
- Add a Perplexity plugin with Agent API support through `responses.LLM`. - [#1552](https://github.com/livekit/agents-js/pull/1552) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
