...
- add enableLogging - [#1975](https://github.com/livekit/agents-js/pull/1975) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Populate ElevenLabs STT confidence from Scribe word log probabilities. - [#2203](https://github.com/livekit/agents-js/pull/2203) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Deprecate the ElevenLabs STT `modelId` option in favor of `model`, matching the TTS plugin. `modelId` still works as a deprecated alias. - [#2018](https://github.com/livekit/agents-js/pull/2018) ([@u9g](https://github.com/u9g))
...
- Avoid persisting per-call STT language overrides on ElevenLabs STT instances. - [#1674](https://github.com/livekit/agents-js/pull/1674) ([@toubatbrian](https://github.com/toubatbrian))
...
- Add ElevenLabs STT `noVerbatim` option. - [#1769](https://github.com/livekit/agents-js/pull/1769) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))

- Add missing ElevenLabs streaming request flags for normalization and logging. - [#1770](https://github.com/livekit/agents-js/pull/1770) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- Close ElevenLabs TTS stream contexts when streaming synthesis is cancelled. - [#1616](https://github.com/livekit/agents-js/pull/1616) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))

- Fix ElevenLabs websocket TTS handling for snake-case context IDs and inactive flush_done messages. - [#1627](https://github.com/livekit/agents-js/pull/1627) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- fix(elevenlabs): raise an API status error when the TTS websocket closes unexpectedly - [#1493](https://github.com/livekit/agents-js/pull/1493) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
...
- feat(elevenlabs): port ElevenLabs STT support from Python agents - [#1367](https://github.com/livekit/agents-js/pull/1367) ([@u9g](https://github.com/u9g))
...
- fix setting autoMode for elevenlabs - [#820](https://github.com/livekit/agents-js/pull/820) ([@simllll](https://github.com/simllll))
