...
- Fix VAD speech buffer AudioFrame to include the prefix-padding pre-roll so START_OF_SPEECH / END_OF_SPEECH events deliver the full pre-rolled audio to downstream consumers (STT, transcription) and `samplesPerChannel` matches the data length. - [#1636](https://github.com/livekit/agents-js/pull/1636) ([@chenghao-mou](https://github.com/chenghao-mou))
...
- persist RNN state between VAD inference calls - [#944](https://github.com/livekit/agents-js/pull/944) ([@toubatbrian](https://github.com/toubatbrian))
